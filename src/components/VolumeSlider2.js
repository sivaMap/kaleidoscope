...
const VolumeSlider2 = ({ isShowRunning }) => {
    const lowVolume = <svg xmlns="http://www.w3.org/2000/svg" width="30" height="36" viewBox="0 0 32 38" fill="none"
    ...
    const highVolume = <svg xmlns="http://www.w3.org/2000/svg" width="46" height="44" viewBox="0 0 44 44" fill="none">
